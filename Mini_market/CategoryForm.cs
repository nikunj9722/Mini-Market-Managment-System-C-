    ...
    public partial class CategoryForm : Form
    {
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Category Added Sucessfully","Add Information",MessageBoxButtons.OK,MessageBoxIcon.Information);
                dBCon.CloseCon();
                getTable();
                clear();
            }
        ...
        private void button_update_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    dBCon.OpenCon();
                    command.ExecuteNonQuery();
                    MessageBox.Show("Category Update Sucessfully", "Update Informtion", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    dBCon.CloseCon();
                    getTable();
                    clear();
                }
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            try
            {
                string deleteQuery = "DELETE Category WHERE CatID=" + TextBox_id.Text +" ";
                SqlCommand command = new SqlCommand(deleteQuery, dBCon.GetCon());
                dBCon.OpenCon();
                command.ExecuteNonQuery();
                MessageBox.Show("Category Delete Sucessfully", "Delete Informtion", MessageBoxButtons.OK, MessageBoxIcon.Information);
                dBCon.CloseCon();
                getTable();
                clear();
            }
