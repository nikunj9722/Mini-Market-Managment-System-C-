    ...
    public partial class ProductForm : Form
    {
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Product Added Sucessfully", "Add Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                dBCon.CloseCon();
                getTable();
                clear();
            }
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    dBCon.OpenCon();
                    command.ExecuteNonQuery();
                    MessageBox.Show("Product Update Sucessfully", "Update Informtion", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    dBCon.CloseCon();
                    getTable();
                    clear();
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    dBCon.OpenCon();
                    command.ExecuteNonQuery();
                    MessageBox.Show("Product Delete Sucessfully", "Delete Informtion", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    dBCon.CloseCon();
                    getTable();
                    clear();
                }
