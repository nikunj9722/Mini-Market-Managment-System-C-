...

    {
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Order Added Sucessfully", "Order Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                dBCon.CloseCon();
                getSellTable();
        ...
        {
            //we need DGVPrinter helper PDF file
            printer.Title = "Nikunj MiniMarket sell List";
